...
public class CommonDiseaseActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            Intent navigationIntent = new Intent(CommonDiseaseActivity.this,NavigationActivity.class);
            startActivity(navigationIntent);
        } else if (id == R.id.nav_profile) {
            Intent profileIntent = new Intent(CommonDiseaseActivity.this, ProfileActivity.class);
            startActivity(profileIntent);
        } else if (id == R.id.nav_history) {
            Intent historyIntent = new Intent(CommonDiseaseActivity.this, MedicalHistoryActivity.class);
            startActivity(historyIntent);
        } else if (id == R.id.nav_reminder) {

        } else if (id == R.id.nav_sub) {
            Intent subprofileIntent = new Intent(CommonDiseaseActivity.this,SubProfileActivity.class);
            startActivity(subprofileIntent);
        } else if (id == R.id.nav_about) {
            Intent aboutIntent = new Intent(CommonDiseaseActivity.this, AboutActivity.class);
            startActivity(aboutIntent);
        } else if (id == R.id.nav_log) {
            FirebaseAuth.getInstance().signOut(); //End user session
            startActivity(new Intent(CommonDiseaseActivity.this, LoginActivity.class)); //Go back to home page
            finish();
        }
    ...
    private void setData() {
        ...
        adapter = new FirebaseRecyclerAdapter<Item , ItemViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull ItemViewHolder holder, final int position, @NonNull final Item model) {
                ...
                switch (holder.getItemViewType())
                {
                    ...
                    { ItemViewHolder viewHolder = (ItemViewHolder)holder;
                        ...
                        viewHolder.setItemClickListener(new ItemClickListener() {
                            ...
                            public void onClick(View view, int position, boolean b) {
                                Toast.makeText(CommonDiseaseActivity.this, "" + items.get(position).getText(), Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                    break;
                    case 1: //with item
                    {
                        ...
                        viewHolder.txt_child_symptoms.setText(model.getSymptoms());
                        viewHolder.txt_child_causes.setText(model.getCauses());
                        viewHolder.txt_child_prevention.setText(model.getPrevention());
            ...
            public ItemViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
                ...
                {
                    View itemView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.layout_with_child_disease,viewGroup,false);
