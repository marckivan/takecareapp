...
public class HerbalFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_herbal, container, false);
    ...
    private void setData() {
        ...
        adapter = new FirebaseRecyclerAdapter<Item , ItemViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull ItemViewHolder holder, final int position, @NonNull final Item model) {
                ...
                switch (holder.getItemViewType())
                {
                    ...
                    case 1: //with item
                    {
                        ...
                        viewHolder.txt_child_scientificname.setText(model.getScientificname());
                        viewHolder.txt_child_commonname.setText(model.getCommonname());
                        viewHolder.txt_child_origin.setText(model.getOrigin());
                        viewHolder.txt_child_medicinaluses.setText(model.getMedicinaluses());
            ...
            public ItemViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
                ...
                {
                    View itemView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.layout_with_child_herbal,viewGroup,false);
